    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    <div class="small mb-1">{{$productsElectro->id}}</div>
                    <h1 class="display-5 fw-bolder">{{$productsElectro->name}}</h1>
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-line-through">{{$productsElectro->price_discount}}</span>
                        <span>{{$productsElectro->price_uah}}</span>
                    </div>
