...
@section('content')
    <div class="container mt-3">
        <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('orders.update', $order) }}">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="name" value="{{$order->name}}">
            </div>
            <div class="mb-3">
                @error('phone')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <input name="phone" type="text" class="form-control" id="phone" value="{{$order->phone}}">
            </div>
            <div class="mb-3">
